...
# Copy full node_modules from builder — the standalone output traces most
# deps, but dynamically-required packages (pg, cheerio, @google/generative-ai,
# etc.) are missed.  Copying the full tree avoids whack-a-mole.
